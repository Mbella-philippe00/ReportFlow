...
class Container_facbbe0aff extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_facbbe0aff $container)
			{
	...
	public function createServiceContainer(): Container_facbbe0aff
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'HOSTNAME' => '2f591955039a',
				'TERM' => 'xterm',
				'IGNITION_LOCAL_SITES_PATH' => '/home/criss/Projects/ReportFlow',
				'WWWUSER' => '1000',
				'LARAVEL_SAIL' => '1',
				'XDEBUG_MODE' => 'off',
